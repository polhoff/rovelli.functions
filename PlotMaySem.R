...
#Sem_AS2_2013_05_01_ModelDayNight <- output_analysis$Sem_AS2_2013_05_01_ModelDayNight
#lorenzo_data <- Sem_AS2_2013_05_01_ModelDayNight [c ( 'date'	,'DO'	,'Cnow'	,'Phot'	,'Gas'	,'ER'	,'C_sat'	,'T'	,'light'	,'Cpercent'	,'daynight')]
